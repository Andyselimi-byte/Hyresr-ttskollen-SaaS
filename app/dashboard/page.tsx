...
import {
  ...
  ArrowRight, ChevronDown, ChevronUp, Clock, MessageSquare,
  CheckCircle, HelpCircle, LogOut,
} from "lucide-react";
...
const FEATURES = [
  { href: "/dashboard/hyresanalys", icon: BarChart2, title: "Hyresanalys",     desc: "Ange din hyra, storlek och ort. Vi jämför mot referenshyror baserade på SCB:s statistik och berättar om du betalar rätt.", free: true },
  { href: "/dashboard/rattigheter", icon: BookOpen,  title: "Rättighetsguide", desc: "En lättläst guide till dina rättigheter som hyresgäst — besittningsskydd, andrahand, störningar, renovering och mer.",   free: true },
  { href: "/dashboard/avtal",       icon: FileText,  title: "Avtalsgranskning", desc: "Ladda upp ditt hyresavtal som PDF. Vi går igenom klausulerna och markerar sådant som kan vara olagligt eller oskäligt.",   free: false },
  { href: "/dashboard/brev",        icon: Mail,      title: "Brevgenerator",    desc: "Välj situation, fyll i dina uppgifter och få ett färdigt brev att skicka till din hyresvärd — korrekt formulerat med rätt lagrum.", free: false },
];

const MISSED_CLAUSES = [
  { title: "Ansvar för normalt slitage",  desc: "Du som hyresgäst ansvarar inte för normalt slitage. En klausul som säger annat strider mot 12 kap. 15 § Jordabalken.", law: "12 kap. 15 § JB" },
  { title: "Otydliga tilläggsavgifter",   desc: "El, vatten, parkering och internet ska specificeras separat i avtalet. Otydliga eller öppna avgifter kan bestridas.",     law: "12 kap. 19 § JB" },
  { title: "Förbud mot andrahand",        desc: "Har du skäliga skäl — t.ex. studier eller arbete på annan ort — har du ofta rätt att hyra ut i andra hand.",             law: "12 kap. 40 § JB" },
  { title: "För kort uppsägningstid",     desc: "Som hyresgäst har du alltid rätt till minst tre månaders uppsägningstid, oavsett vad avtalet säger.",                    law: "12 kap. 4 § JB" },
  { title: "Klausuler om besittningsskydd", desc: "Efter två år har du som regel besittningsskydd. Villkor som försöker ta bort det är ogiltiga.",                        law: "12 kap. 46 § JB" },
  { title: "Deposition som inte återbetalas", desc: "Hyresvärden ska återbetala din deposition efter flytt. Pengar får bara hållas inne för faktiska, dokumenterade skador.", law: "12 kap. JB" },
];

const FAQS = [
  { q: "Är Hyresrättskollen juridisk rådgivning?",  a: "Nej. Vi är ett informationsverktyg som hjälper dig förstå din hyressituation — baserat på 12 kap. Jordabalken och SCB:s statistik. Har du en tvist rekommenderar vi Hyresnämnden eller Hyresgästföreningen." },
  { q: "Hur fungerar hyresanalysen?",               a: "Du anger din hyra, antal rum, area och ort. Vi räknar ut ett referensvärde i kr/m² baserat på SCB:s hyresstatistik för din kommun och visar om din hyra är rimlig — med konkreta råd om vad du kan göra." },
  { q: "Vad händer med mitt avtal när jag laddar upp det?", a: "Dokumentet används bara för att genomföra analysen. Det sparas inte permanent hos oss och delas inte med någon tredje part." },
  { q: "Vad kostar det?",                           a: "Hyresanalysen och rättighetsguiden är gratis. Avtalsgranskning och brevgenerator kräver credits: 5 uppladdningar för 79 kr, 10 för 129 kr eller 25 för 199 kr." },
  { q: "Kan jag få pengarna tillbaka?",             a: "Ja, inom 14 dagar från köp om du inte har använt dina credits. Hör av dig till support@hyresrattskollen.se." },
  { q: "Mitt avtal är inte en PDF — vad gör jag?", a: "Du kan konvertera Word-dokument och bilder till PDF kostnadsfritt via t.ex. ilovepdf.com. De flesta telefoner kan också skriva ut ett dokument direkt som PDF." },
];
...
export default function DashboardHomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {reviewCredits !== null && <ReviewModal credits={reviewCredits} onClose={() => setReviewCredits(null)} />}
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => setPricingOpen(true)}
              className="text-sm bg-[#1a56a0] hover:bg-[#0c447c] text-white font-medium px-4 py-2 rounded-lg transition-colors hidden sm:block">
              Köp uppladdningar
            </button>
            <a href="/api/auth/logout" className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-800">
      ...
      <section className="border-b border-gray-100 px-6 py-16 sm:py-24">
        <div className="max-w-3xl mx-auto">
          <p className="text-sm text-[#1a56a0] font-medium mb-4">Välkommen tillbaka</p>
          ...
          <p className="text-lg text-gray-500 mb-8 max-w-xl leading-relaxed">
            Välj ett verktyg nedan — hyresanalys och rättighetsguide är helt gratis.
            Avtalsgranskning och brevgenerator kräver credits.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            <a href="#verktyg" className="inline-flex items-center justify-center gap-2 bg-[#1a56a0] hover:bg-[#0c447c] text-white font-medium px-6 py-3 rounded-lg transition-colors">
              Se mina verktyg
            </a>
            <button onClick={() => setPricingOpen(true)}
              className="inline-flex items-center justify-center gap-2 border border-gray-300 text-gray-700 hover:border-gray-400 font-medium px-6 py-3 rounded-lg transition-colors">
              Köp credits — från 79 kr
            </button>
          </div>
      ...
      <section id="verktyg" className="px-6 py-16 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Dina verktyg</h2>
      ...
      <section id="rattigheter" className="px-6 py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8">
            <Link href="/dashboard/avtal" className="inline-flex items-center gap-2 text-sm font-medium text-[#1a56a0] hover:underline">
      ...
      {/* FAQ */}
      <section id="faq" className="px-6 py-16 border-b border-gray-100">
        <div className="max-w-3xl mx-auto">
      ...
      {/* Kontakt */}
      <section id="kontakt" className="px-6 py-16">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Kontakt</h2>
            <p className="text-gray-500 mb-8 leading-relaxed">
              Har du frågor om tjänsten, din hyra eller tekniska problem? Hör av dig.
            </p>
